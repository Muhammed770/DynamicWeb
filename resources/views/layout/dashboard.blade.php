                    ...
                    <ul class="mt-4 space-y-2 ">
                        ...
                        <li class="relative flex" x-data="{ showForm: false }" @click.away="showForm = false">
                            ...
                            <form x-show="showForm" class="absolute ml-44 w-60 border border-silver bg-white rounded-md"
                                ...
                                <div class="space-y-6 flex flex-col p-4">
                                    <x-form-input type="text" id="name" name="name" placeholder="create new page"
                                        required />
                        ...
                        <li >
                            <a href="/projects/{{$project->id}}/pages/{{$page->id}}"
                                class="block rounded-lg shadow-sm hover:bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700 {{$current_page_id === $page->id ? 'border bg-gray-200 hover:bg-gray-200' : '' }}">
                                {{ $page->name}}
                            </a>
                        </li>
                        @endforeach
                        ...
                        <li>
                            <a href="/projects/{{$project->id}}/pages/{{$page->id}}"
                                class="block rounded-lg shadow-sm hover:bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700">
                                {{ $page->name}}
                            </a>
                        </li>
                        @endforeach
